...
customerNames = ['Zara', 'Hamza', 'Laiba', 'Iqra', 'Sara']
...
while True:
    ...
    if choiceNumber == "1":
        ...
        if i > 5:
            ...
            while counter_1 <= i:
                # These few lines will take information from customer and then append
                #them to the list.
                ...
                print("========================================")
                # This statement below helps the user to go back to the start of the
                #program (main menu).
